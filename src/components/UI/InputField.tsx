...
const InputField: React.FC<InputFieldProps> = ({ label, id, error, className = "", ...props }) => {
    const baseStyle =
        "mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 text-gray-700 bg-white";
